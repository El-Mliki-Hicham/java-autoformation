   ...
   private String title;
    ...
    public Magazine(String title, String publisher, int issueNumber, int publicationYear) {
     ...
     public Magazine(Magazine src){
         ...
         setPublicationYear(src.publicationYear);
         setIssueNumber(src.issueNumber);
     }
    ...
    public void setIssueNumber(int issueNumber) {
          if(issueNumber <= 0 ){
         throw new IllegalArgumentException("Number year must be greater than 0.");
        }
    ...
    public String toString(){
        return "magazine title : " + this.title ; 
    }
